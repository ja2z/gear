      ...
      <div className="px-5 py-8 relative z-10 flex flex-col justify-center min-h-[calc(100vh-120px)]">
        <div className="space-y-6">
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive w-full p-6 text-center text-lg touch-target bg-primary text-primary-foreground shadow-xs hover:bg-blue-900 relative no-underline"
          >
